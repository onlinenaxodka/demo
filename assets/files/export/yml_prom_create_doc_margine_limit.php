...
file_put_contents("logs/yml_prom.log", date('Y-m-d H:i:s')." - Start create XML docs.\n", FILE_APPEND | LOCK_EX);
...
if ($xml->save('yml_prom/'.$linkname.'.xml')) {
	...
	file_put_contents("errors/yml_prom.log", date('Y-m-d H:i:s')." - Не удалось сохранить файл ".$linkname.".xml фида данных. Возможно у файла не достаточно прав доступа.\n", FILE_APPEND | LOCK_EX);
...
file_put_contents("logs/yml_prom.log", date('Y-m-d H:i:s')." - Finish create XML docs.\n", FILE_APPEND | LOCK_EX);
