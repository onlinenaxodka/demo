...
$soap_GetContentGoods = '<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" soap:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
   <soap:Body>
      <GetContentGoods xmlns="https://soap.yugcontract.ua/API">
         ...
         <Content>
            <content_type xsi:type="xsd:string">category</content_type>
            <content_id xsi:type="xsd:int">24</content_id>
         </Content>
      </GetContentGoods>
   </soap:Body>
</soap:Envelope>';
...
/*$soap_GetPrice = '<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" soap:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
   <soap:Body>
      <GetPrice xmlns="https://soap.yugcontract.ua/API">
         <Session>
            <hash xsi:type="xsd:string">'.$auth_hash.'</hash>
            <session_id xsi:type="xsd:string">'.$auth_session_id.'</session_id>
         </Session>
         <params>
            <id xsi:type="xsd:int">6069644</id>
         </params>
      </GetPrice>
   </soap:Body>
</soap:Envelope>';
...
$ch = curl_init('https://soap.yugcontract.ua');
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
curl_setopt($ch, CURLOPT_POSTFIELDS, $soap_GetPrice);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, true);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
    'Content-Type: text/xml; charset=utf-8',
  'SOAPAction: https://soap.yugcontract.ua/API#GetPrice')
);
...
//$clean_soap_xml = str_ireplace(['SOAP-ENV:', 'SOAP:'], '', $result);
//$soap_price_xml = simplexml_load_string($clean_soap_xml);
