	...
	if (file_exists($xml_file)) {
		...
		foreach ($xml->Item as $item) {
			...
			if (count($item->Свойства->ItemSv) > 0) {
				...
				/*$goods_template = "{\"uk\":{\"Производитель\":\"".$goods_vendor."\",\"Страна производитель\":\"".$goods_country."\",\"Гарантия\":\"3 мес.\",\"Предоплата 100%\":\"оплата полной стоимости товара при оформлении заказа\"},\"ru\":{\"Производитель\":\"".$goods_vendor."\",\"Страна производитель\":\"".$goods_country."\",\"Гарантия\":\"3 мес.\",\"Предоплата 100%\":\"оплата полной стоимости товара при оформлении заказа\"}}";

				if (!empty($template_opt)) {

					$goods_template = "{\"uk\":{\"Важно!\":\"".$template_opt."\",\"Производитель\":\"".$goods_vendor."\",\"Страна производитель\":\"".$goods_country."\",\"Гарантия\":\"3 мес.\",\"Предоплата 100%\":\"оплата полной стоимости товара при оформлении заказа\"},\"ru\":{\"Важно!\":\"".$template_opt."\",\"Производитель\":\"".$goods_vendor."\",\"Страна производитель\":\"".$goods_country."\",\"Гарантия\":\"3 мес.\",\"Предоплата 100%\":\"оплата полной стоимости товара при оформлении заказа\"}}";
		...
		header('Location: /admin/goods_upload/?mobiking_part_file_3=success');
		exit;
