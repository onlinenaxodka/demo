...
while ($catalog = mysqli_fetch_assoc($query)) {
	...
	if ($catalog['id'] != $catalog['level_id']) {
		...
		file_put_contents(__DIR__ . "/count_goods_in_catalog_admin-errors.log", date('Y-m-d H:i:s')." - No update catalog id: ".$catalog_id."\n", FILE_APPEND | LOCK_EX);
	...
	echo "#: ".$n.", id: ".$catalog_id.", cnt: ".$count_goods_in_catalog.", time: ".$time." sec.\n";*/
...
$dir_log_file = __DIR__ . "/../logs/assets-ajax-count_goods_in_catalog_admin.log";
