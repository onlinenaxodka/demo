...
class Slim {
    ...
    public static function saveFile($data, $name, $user_id, $path = '../../data/images/users/', $uid = true) {
        ...
        $typeimg = array('jpg', 'jpeg', 'png', 'gif', 'bmp');
        for ($i=0; $i < count($typeimg); $i++) { 
            $imgname = $path.'user'.$user_id.'.'.$typeimg[$i];
